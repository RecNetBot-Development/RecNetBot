...
from utility.account.resolve_identities import resolve_identities
from utility.account.resolve_pronouns import resolve_pronouns
...
class User(BaseDataclass):
    ...
    pronouns: list = field(default=None)
    identities: list = field(default=None)
    ...
    def from_data(cls, data, **kwargs):
        ...
        pronouns = [pronoun for pronoun in resolve_pronouns(data["personalPronouns"])]
        identities = [identity for identity in resolve_identities(data["identityFlags"])]
