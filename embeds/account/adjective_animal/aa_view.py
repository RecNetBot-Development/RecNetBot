...
class AdjectiveAnimal(discord.ui.View):
    ...
    def start(self):    
        ...
        return self, adjective_animal_embed(self.generate_adjective_animal())
    ...
    @discord.ui.button(emoji=get_emoji('random'), style=discord.ButtonStyle.primary)
    async def another(self, button, interaction):
        await edit_message(interaction=interaction, embed=adjective_animal_embed(self.generate_adjective_animal()), view=self)